      ...
      <SidebarProvider defaultOpen={true} style={{ "--sidebar-width": "14rem" } as React.CSSProperties}>
        <div className="flex flex-1 min-h-0 w-full">
          ...
          <main ref={mainContentRef} className="flex-1 overflow-y-auto">
            {/* Content Section */}
            {activeTab === "content" && (
            <div key={selectedModuleId} className="max-w-3xl mx-auto py-8 pb-24 px-6">
              {course.modules.length > 0 ? (
                <>
                  {/* Course Stats */}
                  <div className="flex items-center justify-between mb-6" data-testid="course-stats">
                      ...
                      <article className="prose prose-neutral dark:prose-invert max-w-none" data-testid="module-content">
                        ...
                        <div className="group flex items-start gap-3 mb-8">
                          <div
                            ...
                            className={`flex-1 text-2xl font-bold outline-none rounded transition-colors ${
                              isEditMode ? "cursor-text focus:bg-muted/30 focus:px-2 focus:-mx-2" : "cursor-default"
                            }`}
                              ...
                              >
                                ...
                                <div className="flex items-start gap-2 mb-3">
                                  ...
                                  <div
                                    ...
                                    className={`flex-1 text-lg font-semibold outline-none rounded transition-colors ${
                                      isEditMode ? "cursor-text focus:bg-muted/30 focus:px-2 focus:-mx-2" : "cursor-default"
                                    }`}
