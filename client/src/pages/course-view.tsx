...
import { Lock, DollarSign, BookOpen, ArrowLeft, Layers } from "lucide-react";
          ...
          >
            <Card className="max-w-md w-full">
              ...
              <CardContent className="space-y-6 pb-8">
                <div className="flex items-center justify-center gap-6 py-4 px-6 rounded-xl bg-muted/50">
